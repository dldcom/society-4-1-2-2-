...
export const defaultPlaces = [
  { id: "board", name: "알바 게시판", x: 1600, y: 1030, w: 230, building: "packing-room", icon: "📋", npc: { name: "게시판 지기", role: "마을 안내원", portrait: "📋", sprite: 0, greeting: "왔구나! 오늘 마을이 꽤 분주하지? 게시판 앞은 늘 새로운 소식이 모이는 곳이야.", jobLine: "여기 붙은 일들은 전부 마을 사람들이 직접 부탁한 거야. 마음 가는 일부터 골라 봐.", shopLine: "무언가 사고 싶다면 가게 주인에게 말을 걸어 봐. 번 코인을 어디에 쓸지도 중요한 선택이거든." } },
  ...
  { id: "game-center", name: "게임센터", x: 805, y: 1660, w: 310, building: "convenience-store", icon: "🕹️", npc: { name: "진우 사장님", role: "게임센터 사장", portrait: "🕹️", sprite: 4, greeting: "삐빅! 어서 와. 게임기 소리가 들리면 괜히 발걸음이 빨라지지?", jobLine: "방금 또 한 대가 멈췄어. 색깔 전선만 헷갈리지 않으면 돼. 연결하고 버튼까지 끼우면 다시 켜질 거야.", shopLine: "수리 말고 놀러 온 거라면 미니 오락기도 있어. 한 판 해 볼래?" } },
  ...
  { id: "bakery", name: "빵집", x: 820, y: 1190, w: 330, building: "parcel-center", icon: "🥐", npc: { name: "단비 주인", role: "빵집 주인", portrait: "🥐", sprite: 7, greeting: "어서 와! 빵 냄새 따라 여기까지 온 거지? 오늘은 버터 향이 특히 좋아.", jobLine: "마침 부탁할 일이 있어. 식기 전에 배달해야 해. 길만 잘 찾으면 손님이 정말 좋아할 거야.", shopLine: "지금은 배달이 밀려서 정신이 없어. 조금만 도와주면 정말 고맙겠다." } },
  ...
  { id: "photo-studio", name: "사진관", x: 3000, y: 1085, w: 185, building: "bus-stop", icon: "📸", npc: { name: "온유 작가", role: "사진관 주인", portrait: "📸", sprite: 9, greeting: "어서 와. 창가 빛이 좋아서 오늘 사진이 꽤 예쁘게 나올 것 같아.", jobLine: "좋은 표정은 정말 한순간이라, 셔터 누를 사람이 늘 필요해. 손님이 활짝 웃을 때 찰칵! 그 순간을 놓치지 않는 게 제일 중요해.", shopLine: "사진은 나중에 보면 그날의 기분까지 떠오르거든. 한 장 남겨 볼래?" } }
];
