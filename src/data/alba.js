...
export const jobs = [
  {
    ...
    card: { id: "card-pizza-job", type: "production", badge: "🍕", title: "피자 만들기 알바", description: "피자 만들기", feedback: "사람들이 먹을 음식을 만드는 일은 생산 활동이에요." },
    config: {
      base: "🍕",
      revealMs: 3000,
      choices: ["🧀", "🍄", "🫒", "🌽", "🍅", "🥓", "🌿", "🧅"],
  ...
  },
  {
    ...
    card: { id: "card-icecream-job", type: "production", badge: "🍦", title: "아이스크림 만들기 알바", description: "아이스크림 만들기", feedback: "음식을 만들어 손님에게 제공하는 일은 생산 활동이에요." },
    config: {
      choices: ["🍦", "🥄", "🍨", "🍓", "🍫", "🍪", "🍒", "🍯"],
      orders: [
        ["🍦", "🍨", "🍓", "🍒"],
  ...
  },
  {
    ...
    card: { id: "card-pet-job", type: "production", badge: "🐾", title: "펫카페 돌봄 알바", description: "동물 돌봄", feedback: "서비스를 제공해 사람들이 이용할 수 있게 하는 일도 생산 활동이에요." },
    config: {
      pets: [
  ...
  },
  {
    ...
    card: { id: "card-stage-job", type: "production", badge: "🎤", title: "공연장 준비 알바", description: "무대 준비", feedback: "즐길 수 있는 서비스를 준비하고 제공하는 일은 생산 활동이에요." },
    config: {
      notes: ["💡", "🎤", "👏", "💡", "👏", "🎤", "💡", "🎤", "👏", "👏", "💡", "🎤"],
      targetHits: 9,
      beatMs: 720,
  ...
  },
  {
    ...
    card: { id: "card-delivery-job", type: "production", badge: "📦", title: "택배 분류 알바", description: "택배 분류", feedback: "물건이 필요한 사람에게 도착하도록 나누고 보내는 일도 생산 활동이에요." },
    config: {
      targetHits: 8,
      beatMs: 1120,
      travelMs: 1800,
  ...
  },
  {
    ...
    card: { id: "card-bread-job", type: "production", badge: "🥐", title: "빵굽기 알바", description: "빵 굽기", feedback: "사람들이 먹을 음식을 만드는 일은 생산 활동이에요." },
    config: {
      targetBakes: 6,
      ovens: [
  ...
  },
  {
    ...
    card: { id: "card-robot-job", type: "production", badge: "🤖", title: "배달 로봇 수리 알바", description: "로봇 수리", feedback: "사람들이 편리하게 서비스를 이용하도록 기계를 고치는 일은 생산 활동이에요." },
    config: {
      slots: [
...
export const consumptions = [
  { id: "eat-pizza", placeId: "pizza-shop", title: "피자 한 조각 먹기", icon: "🍕", costCoins: 150, energyGain: 1, category: "recovery", resultSticker: "🍕", card: { id: "card-eat-pizza", type: "consumption", badge: "🍕", title: "피자 먹기", description: "피자 사 먹기", feedback: "돈을 내고 음식을 사 먹는 것은 소비 활동이에요." } },
  { id: "eat-icecream", placeId: "icecream-shop", title: "아이스크림 먹기", icon: "🍦", costCoins: 180, energyGain: 1, moodGain: 1, category: "recovery", resultSticker: "🍦", card: { id: "card-eat-icecream", type: "consumption", badge: "🍦", title: "아이스크림 먹기", description: "간식 사 먹기", feedback: "필요하거나 원하는 물건을 사는 것은 소비 활동이에요." } },
  { id: "buy-cape", placeId: "outfit-shop", title: "별 망토 사기", icon: "⭐", costCoins: 300, category: "outfit", equip: "별 망토", resultSticker: "⭐", card: { id: "card-buy-cape", type: "consumption", badge: "⭐", title: "별 망토 사기", description: "꾸미기 물건 사기", feedback: "돈을 내고 물건을 사는 것도 소비 활동이에요." } },
  { id: "watch-show", placeId: "stage", title: "공연 보기", icon: "🎟️", costCoins: 250, category: "service", resultSticker: "🎟️", card: { id: "card-watch-show", type: "consumption", badge: "🎟️", title: "공연 보기", description: "공연 보기", feedback: "돈을 내고 서비스를 이용하는 것도 소비 활동이에요." } }
];
